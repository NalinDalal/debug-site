...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full font-sans bg-white md:px-10 dark:bg-neutral-950"
      ref={containerRef}
    >
      <div className="py-20 px-4 mx-auto max-w-7xl md:px-8 lg:px-10">
      ...
      <div ref={ref} className="relative pb-20 mx-auto max-w-7xl">
        {data.map((item, index) => (
          ...
          >
            <div className="flex sticky top-40 z-40 flex-col items-center self-start max-w-xs md:flex-row md:w-full lg:max-w-sm">
              <div className="flex absolute left-3 justify-center items-center w-10 h-10 bg-white rounded-full md:left-3 dark:bg-black">
                <div className="p-2 w-4 h-4 rounded-full border bg-neutral-200 border-neutral-300 dark:bg-neutral-800 dark:border-neutral-700" />
              </div>
