...
import {ToastAction} from "@/components/ui/toast"; // Import EmailJS

const EventsPage = () => {
    const user = {isAdmin: false}; // Example user object. Replace with real data.
    ...
    const toggleAdminMode = () => {
        if (!user.isAdmin) {
            toast({
                ...
                variant: "default",
                action:
                    (<ToastAction altText={"close"} className={"hover:text-red-500"}
